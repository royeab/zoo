...
public class AnimalFactory {
    ...
    public final Map<String, Animal> animalDictionary = new HashMap<String, Animal>();

    public Animal generateAnimal(String animalName) throws InvalidAnimalName{
        if (!animalDictionary.containsKey(animalName)) {
            createNewAnimal(animalName);
        }

        return animalDictionary.get(animalName);
    }

    private void createNewAnimal(String animalName) throws InvalidAnimalName {
        switch (animalName) {
